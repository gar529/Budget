...
public class ListViewAdapterCopyBudgetList extends BaseAdapter {
    ...
    public ListViewAdapterCopyBudgetList(Context context, ListDataObj listData){
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(position == 0){
            category = (context.getResources().getString(R.string.total_spent));
